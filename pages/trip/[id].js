...
export async function getStaticPaths() {
  const res = await fetch('https://dull-puce-coypu-kilt.cyclic.app/api/trips/?page=1&perPage=10');
...
export async function getStaticProps(context) {
  ...
  const res = await fetch(`https://dull-puce-coypu-kilt.cyclic.app/api/trips/${context.params.id}`);
